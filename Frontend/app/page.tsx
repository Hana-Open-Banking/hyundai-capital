  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="main-section">
        {/* Header */}
        <header
          className={`header-nav relative transition-all duration-300 ${isHeaderHovered ? "bg-white" : ""}`}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-8">
                ...
                <nav className="hidden md:flex items-center space-x-8">
                  <Link
                    href="#"
                    className={`nav-link transition-colors duration-300 hover:text-blue-700 ${isHeaderHovered ? "!text-blue-500 font-semibold" : ""}`}
                  >
                    자동차
                  </Link>
                  <Link
              ...
              <nav className="hidden lg:flex items-center space-x-6 text-sm">
                ...
                <button
                  ...
                  className={`nav-link-right hover:text-blue-700 flex items-center transition-colors duration-300 ${
                    showProductMenu ? "text-white border-b-2 border-white pb-1" : ""
                ...
                <Link
                  href="#"
                  className={`nav-link-right transition-colors duration-300 hover:text-blue-700 ${isHeaderHovered ? "!text-blue-500 font-semibold" : ""}`}
                >
                  서비스 이벤트
                </Link>
                <Link
                ...
                <Link
                  href="#"
                  className={`nav-link-right flex items-center transition-colors duration-300 hover:text-blue-700 ${isHeaderHovered ? "!text-blue-500 font-semibold" : ""}`}
                >
                ...
                {userData ? (
                  <div className="relative" ref={menuRef}>
                    <button
                      ...
                      className={`nav-link-right flex items-center space-x-1 hover:text-blue-700 transition-colors duration-300 ${isHeaderHovered ? "!text-blue-500 font-semibold" : ""}`}
                    >
                ...
                <Search
                  className={`w-4 h-4 cursor-pointer hover:text-blue-700 transition-colors duration-300 ${isHeaderHovered ? "!text-blue-500" : "text-white/80"}`}
                />
              </nav>
            </div>
          </div>
            ...
            <div className="absolute left-0 right-0 top-full bg-white shadow-lg border-t border-gray-200 z-40">
              <div className="flex justify-center py-8">
                <div className="grid grid-cols-4 gap-16 max-w-4xl">
                  ...
                  {/* Column 2: 이용금액 결제 */}
                  <div>
                    <h3 className="font-bold text-gray-900 mb-4 text-base">이용금액 결제</h3>
                    <ul className="space-y-2">
                      <li>
                        <Link href="#" className="text-sm text-gray-600 hover:text-blue-600 transition-colors block">
                          청구금액 결제
                  ...
                  {/* Column 3: 결제정보 관리 */}
                  <div>
                    <h3 className="font-bold text-gray-900 mb-4 text-base">결제정보 관리</h3>
                    <ul className="space-y-2">
                      <li>
                        <Link href="#" className="text-sm text-gray-600 hover:text-blue-600 transition-colors block">
                          결제정보 조회 변경
                  ...
                  {/* Column 4: 회원정보 관리 */}
                  <div>
                    <h3 className="font-bold text-gray-900 mb-4 text-base">회원정보 관리</h3>
                    <ul className="space-y-2">
                      <li>
                        <Link href="#" className="text-sm text-gray-600 hover:text-blue-600 transition-colors block">
                          회원정보 조회 변경
        ...
        <div className="max-w-7xl mx-auto pt-16">
          <div className="grid md:grid-cols-3 h-full min-h-[350px]">
            {/* 자동차금융 */}
            <div
              className={`loan-section ${hoveredSection && hoveredSection !== "auto" ? "dimmed" : "active"}`}
            ...
            >
              ...
              <div className="loan-buttons">
                <div className="loan-button">
                  <span className="button-text" onClick={() => handleTextClick("신차", "자동차금융")}>
                    신차
                  </span>
                  <span className="button-text" onClick={() => handleTextClick("중고차", "자동차금융")}>
                    중고차
                  </span>
                </div>
              </div>
            ...
            {/* 신용대출 */}
            <div
              className={`loan-section ${hoveredSection && hoveredSection !== "credit" ? "dimmed" : "active"}`}
            ...
            >
              ...
              <div className="loan-buttons">
                <div className="loan-button">
                  <span className="button-text" onClick={() => handleTextClick("신용대출", "신용대출")}>
                    신용대출
                  </span>
                  <span className="button-text" onClick={() => handleTextClick("자동차담보대출", "신용대출")}>
                    자동차담보대출
                  </span>
                </div>
              </div>
            ...
            {/* 주택대출 */}
            <div
              className={`loan-section ${hoveredSection && hoveredSection !== "home" ? "dimmed" : "active"}`}
            ...
            >
              ...
              <div className="loan-buttons">
                <div className="loan-button">
                  <span className="button-text" onClick={() => handleTextClick("주택담보대출", "주택대출")}>
                    주택담보대출
                  </span>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="service-card group">
              ...
              <div className="service-card-content">
                <p className="service-card-description">방문부터 매각까지 전 과정 수수료 0원!</p>
              </div>
            </div>
            ...
            <div className="service-card group">
              ...
              <div className="service-card-content">
                <p className="service-card-description">온라인으로 간편하게 승계 신청하세요!</p>
              </div>
            </div>
